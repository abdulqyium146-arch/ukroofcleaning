...
const inputClass = 'w-full bg-brand-bg border border-brand-border focus:border-brand-accent rounded-lg px-4 py-3 text-brand-text1 text-sm outline-none transition-colors placeholder:text-brand-text3 min-h-[44px]'
      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-5 gap-12">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="space-y-4">
            <a href="tel:+447845463877" className="flex items-start gap-4 bg-brand-surface border border-brand-border rounded-xl p-5 hover:border-brand-border2 transition-colors group min-h-[44px]">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="bg-brand-surface border border-brand-border rounded-xl p-8 space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input {...register('phone')} type="tel" className={inputClass} placeholder="07700 000000" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input {...register('town')} className={inputClass} placeholder="Chorley" />
              ...
              <div>
                ...
                <select
                  {...register('service')}
                  className="w-full bg-brand-bg border border-brand-border focus:border-brand-accent rounded-lg px-4 py-3 text-brand-text1 text-sm outline-none transition-colors min-h-[44px]"
                >
              ...
              <button
                ...
                className="w-full bg-brand-accent hover:bg-brand-accentDim disabled:opacity-60 text-white font-body font-medium text-sm uppercase tracking-wide py-4 rounded-lg transition-colors min-h-[44px]"
              >
